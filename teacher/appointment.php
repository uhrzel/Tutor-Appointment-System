...
<body>
            ...
            <tr>
                ...
                <td width="15%">
                    ...
                    <p class="heading-sub12" style="padding: 0;margin: 0;">
                        ...
                        $list110 = $database->query("select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join student on student.studentid=appointment.studentid inner join teacher on schedule.teacherid=teacher.teacherid  where  teacher.teacherid=$userid ");
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                        ...
                                        <td style="text-align:center;">' .
                                                ($status == "pending" ? '<a href="?action=approve&id=' . $appoid . '" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Approve</font></button></a> <br> <br>' : '') . '
    ...
    if ($_GET) {
        ...
        if ($action == 'approve') {
            ...
            $emailQuery = "SELECT studentemail FROM student WHERE studentid IN (SELECT studentid FROM appointment WHERE appoid='$id')";
            $result = $database->query($emailQuery);
            $row = $result->fetch_assoc();
            $patientEmail = $row['studentemail'];
            ...
            $mail->Body = '<h1 align=center>Approved Appointment</h1><br><h3 align=center style="font-size: 20px;">Dear ' . $pname . ',</h3><br><p align=center style="font-size: 18px;">Your schedule has been approved.</p>';
            $mail->AltBody = 'Approved Appointment';
